  ...
  return (
    <section className="hero-section flex items-center">
      ...
      <div className="wrapper">
        <div className="divider h-full flex flex-row items-center justify-between ">
          <div className="hero-message max-w-[500px] flex flex-col gap-9">
            <p>Neque porro quisquam est qui dolorem ipsum quia</p>
            <h1>Fly Higher, Every Step!</h1>
            <p>
              Step into the legend. Own the court, own the streets. Wear the
              legacy. Play the future.
            </p>
            <div className="msg-buttons flex gap-8">
          ...
          <Image
            ...
            className="-rotate-[33deg] drop-shadow-[20px_20px_10px_rgba(0,0,0,0.7)]"
          />
        </div>
      </div>
    </section>
