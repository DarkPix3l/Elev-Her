    ...
    <>
      <aside ref={sidenavRef} className={sidenavClasses}>
        <div className="p-4 flex flex-col text-white">
          <div>
            <h2 className="text-xl font-bold">Fast Travel</h2>
          ...
          <div className="scroll-links">
            <Link href="#hero" onClick={closeSidenav}>
              Hero
            </Link>
            <Link href="#products" onClick={closeSidenav}>
              Products
            </Link>
            <Link href="#explore" onClick={closeSidenav}>
              Explore
            </Link>
            <Link href="#choose-us" onClick={closeSidenav}>
              Why Us
            </Link>
          </div>
        </div>
      ...
      {isOpen && (
        ...
        ></div> */
        <div
          className={`bg-black/80 inset-0 w-screen h-screen absolute z-11 blur-sm ${isOpen ? 'animate-fade-in' : 'animate-fade-out'}`}
          style={{
