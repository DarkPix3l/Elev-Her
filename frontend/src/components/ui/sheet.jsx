  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          'bg-[linear-gradient(to_bottom,oklch(36.194%_0.03849_276.321),oklch(0.4775_0.0947_273.46))] data-[state=open]:animate-in data-[state=closed]:animate-out fixed z-50 flex flex-col gap-4 shadow-lg transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 border-white',
          side === 'right' &&
